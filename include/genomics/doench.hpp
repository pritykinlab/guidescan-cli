/*
 *   Scores for off-target CFD calculations
 *
 *   Doench, John G et al.
 *   "Optimized sgRNA design to maximize activity and minimize off-target effects of CRISPR-Cas9."
 *   Nature biotechnology vol. 34,2 (2016): 184-191.
 *   doi:10.1038/nbt.3437
 */

#ifndef GUIDESCAN_CLI_DOENCH_HPP
#define GUIDESCAN_CLI_DOENCH_HPP

namespace genomics {
    std::map<std::string, double> mm_scores{
            {"rU:dT,12", 0.8},
    ...
    std::map<std::string, double> pam_scores{
            {"AA", 0.0},
            {"AC", 0.0},
...
#endif //GUIDESCAN_CLI_DOENCH_HPP
