...
cell_example_1,GCCGTTCAGGAGCTCGACGA,NGG,chrIV,5499,-
cell_example_2,CAAAATATGAAATTTTCAAG,NGG,chrIV,23896,+
cell_example_3,TCTACTGAAAGTTTGCAAAA,,chrIV,5499,-
cell_example_4,TATAAACTGTCAAAGTTGAG,NGG,chrIV,23703,+
  \end{minted}
...
\begin{minted}[frame=lines]{shell-session}
  ...
  guidescan enumerate cell.index -f $f -n 1 --format sam -o $f.sam -a NAG;\
  done
\end{minted}
...
\begin{minted}[frame=lines, breaklines]{shell-session}
  $ python scripts/decode_database.py cell.sam\ GCF_000002985.6_WBcel235_genomic.fna > cell.csv
\end{minted}
